//3. At the top of the script.js file, create a new array called buttonColours and set it to hold the sequence "red", "blue", "green", "yellow" .
var buttonColours = ["red", "blue", "green", "yellow"];

//5. At the top of the script.js file, create a new empty array called gamePattern.
var gamePattern = [];

//12. At the top of the script.js file, create a new empty array with the name userClickedPattern.
...
//1. Inside script.js create a new function called nextSequence()
